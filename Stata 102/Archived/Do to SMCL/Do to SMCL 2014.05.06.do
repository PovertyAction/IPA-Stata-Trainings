...
//if strpos("`infile'", "For-Loops and Macros - answers") stop
...
//if strpos("`infile'", "by - problem set") stop
...
* Enclose commands outside blocks in {stata} directives, adding indent and internal spaces.
